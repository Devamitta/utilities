...
df_dpd['pali_3'] = df_dpd['pali_3'].str.replace('\d+', '')
df_dpd['pali_3'] = df_dpd['pali_3'].str.replace(' ', '')
df_dpd['pali_3'] = df_dpd['pali_3'].str.replace('.', '')


df_merged = pd.merge(df_dpd, df_freq, how='left')

df_merged = df_merged.drop(['pali_3'], axis=1)

# df_merged["pali_1"] = df_merged["Pāli1"]

# df_merged = df_merged.drop(['Pāli1'], axis=1)
